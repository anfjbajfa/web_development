...
heading.title = store.state.developmentData.heading.title
heading.description = store.state.developmentData.heading.description


let data = store.state.developmentData.features
