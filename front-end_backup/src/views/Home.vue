<template>
  ...
  <div class="hero-section" v-fade="'fade-in'">
    ...
    <Swiper :modules="modules" :slides-per-view="1" :autoplay="{ delay: 5000, pauseOnMouseEnter: true }"
        ...
        <div class="overlay">
          <div class="content-container">
            <div class="swiper-inside">
              <h1>什么是测绘?</h1>
              <h2>
                测绘是大地与天空的对话，借助专业技能，<br />
                将自然的脉络和人类的足迹细致描绘在蓝图之上
              </h2>
              <button class="cta-button" @click="toMore('/cehuiLearnMore')">了解更多</button>
            </div>
          </div>
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <img src="/CNN.gif" alt="测绘的未来" class="background-image" />
        <div class="overlay">
          <div class="content-container">
            <div class="swiper-inside">
              <h1>测绘的未来</h1>
        ...
        <div class="overlay">
          <div class="content-container">
            <div class="swiper-inside">
              <h1>我们的服务</h1>
              <h2>
                提供硬件软件数据配套服务，满足各类需求<br />
                从基础测量到高级数据分析，我们都是您的可靠伙伴
              </h2>
              <button class="cta-button" @click="toMore('/services#gong_cheng')">了解更多</button>
            </div>
          </div>
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <img src="/digitalization.gif" alt="智能数字化" class="background-image" />
        <div class="overlay">
          <div class="content-container">
            <div class="swiper-inside">
              <h1>智能数字化测绘</h1>
              <h2>
                利用大疆无人机，提供精准的测绘解决方案<br />
                从数据采集到三维建模，全流程数字化服务，助您掌握地理信息
              </h2>
              <button class="cta-button" @click="toMore('/shuziLearnMore')">了解更多</button>
            </div>
          </div>
        </div>
      </SwiperSlide>
  ...
  <LastestProjects v-lazy v-fade></LastestProjects>
  <projectTheme v-lazy v-fade></projectTheme>
...
import RecentActivies from './RecentActivies.vue'
